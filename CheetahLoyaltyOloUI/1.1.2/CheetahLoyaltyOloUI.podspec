Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "git@github.com:LoyalSphere/cheetah-loyalty-ios-sdk-releases.git", :tag => "Olo-UI-#{spec.version}" }
  spec.ios.vendored_frameworks = "CheetahLoyaltyOloUI/CheetahLoyaltyOloUI.xcframework"
  spec.framework = 'Foundation'
  spec.ios.framework = 'UIKit'
  spec.dependency "CheetahLoyaltyUI", "~> 1.8.0"
  spec.dependency "CheetahLoyaltyUtils", "~> 1.1.0"
  spec.dependency "CheetahLoyaltyOloCore", "~> 1.1.1"
end
